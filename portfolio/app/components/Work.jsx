...
const Work = (isDarkMode) => {
  return (
    ...
    id='work' className='w-full px-[12%] py-10 scroll-mt-20'>
      ...
      className='text-center text-5xl font-Ovo'>My latest work</motion.h2>
        ...
        className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo'>
            Welcome to my software engineering portfolio! Explore a collection of projects showcasing my expertise in software development.
        </motion.p>
    ...
    href="" className='w-max flex items-center justify-center gap-2 text-gray-700 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover'>
        Show more <Image src={isDarkMode ? assets.right_arrow_bold_dark : assets.right_arrow_bold} alt='right_arrow' className='w-5'/>
    </motion.a>
    </motion.div>
  )
}
